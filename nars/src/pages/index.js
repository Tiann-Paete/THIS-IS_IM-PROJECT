          ...
          {!isMobile && (
            <nav className="flex items-center">
              ...
              <button 
                ...
                className="bg-orange-500 text-neutral-100 px-4 py-2 rounded-lg hover:bg-orange-600 transition duration-300 flex items-center"
              >
          ...
          <div className="container mx-auto max-w-7xl px-4 relative z-10">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <button 
                ...
                className="bg-orange-500 text-neutral-100 px-8 py-3 rounded-lg text-lg hover:bg-orange-600 transition duration-300 shadow-md flex items-center justify-center mx-auto md:mx-0"
              >
